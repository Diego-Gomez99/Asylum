...
#define UE_PROJECT_NAME AsylumProject
#define UE_TARGET_NAME AsylumProjectEditor
#define UE_MODULE_NAME "AsylumProject"
...
#define ASYLUMPROJECT_API DLLEXPORT
